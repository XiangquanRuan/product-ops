...
1. **Read the full reference file** before producing output — don't skim
2. **Adapt to the user's context** — ask clarifying questions if the request is vague
3. **Offer to save/export** — ask if the user wants the output saved to file, sent via Lark, etc.
4. **Suggest next steps** — after completing one workflow, suggest related workflows

## Quick Reference: Common Commands

| What user says | What you do |
|----------------|-------------|
| "今天站会" | Load `daily-operations.md`, produce standup report |
...
3. **Templates are starting points** — always customize to user's product, team, and context
